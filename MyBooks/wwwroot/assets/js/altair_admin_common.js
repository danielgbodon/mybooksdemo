        ...
        lang_switcher: function() {
            ...
            if($lang_switcher.length) {
                $lang_switcher.selectize({
                    dropdownOffsetTop: 30,
                    options: [
                        { id: 1, title: 'English', value: 'gb' },
                        { id: 2, title: 'Spanish', value: 'es' }
                    ],
                    render: {
                        option: function(data, escape) {
                            return  '<div class="option">' +
                                '<i class="uk-margin-small-right item-icon flag-' + escape(data.value).toUpperCase() + '"></i>' +
                    ...
                    onChange: function (value) {
                        $('#formCulture input[name="Culture"]').val(value);
                        $('#formCulture').submit();
                    }
                });
        ...
        content_preloader_show: function(style,variant,container,width,height) {
            ...
            if(!$body.find('.content-preloader').length) {
                ...
                var preloader_content = (style == 'regular')
                    ? '<img src="/img/spinners/spinner' + image_density + '.gif" alt="" width="32" height="32">'
